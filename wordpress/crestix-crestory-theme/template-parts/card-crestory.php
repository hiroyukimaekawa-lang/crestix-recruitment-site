<?php $term = crestix_crestory_first_term(); $tags = array_slice(crestix_crestory_tag_terms(), 0, 3); ?>
<a class="crestory-card" href="<?php the_permalink(); ?>">
  <div class="crestory-card-image"><?php if (has_post_thumbnail()) { the_post_thumbnail("medium_large"); } else { echo "<span>CRESTORY</span>"; } ?></div>
