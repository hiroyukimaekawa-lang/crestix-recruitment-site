  ...
  const members = {
    ...
    maekawa: {
      ...
      talkParagraphs: [
        ...
        'ISは、ただ電話をかける仕事ではありません。どの市場に、どんな仮説で、どうアプローチし、何を改善すれば成果につながるのか。数字を見ながら、組織全体で勝ち筋をつくっていく仕事です。',
        '僕自身、無口だったり、優柔不断な一面もあります。けれど、Crestixに来てから「やらずに諦めるなら、やってから諦めればいい。」という考え方が、より強くなりました。',
        '営業組織をどう強くするのか。ISをどう仕組み化するのか。数字と改善にどう向き合うのか。そして、Crestixで挑戦する中で自分自身がどう変わってきたのか。そんな話ができたら嬉しいです。'
      ],
      target: [
      ...
      introParagraphs: [
        '株式会社Crestix 取締役／DX責任者。\n2025年4月にCrestixへ参画し、現在は社内DXやHD事業部ISを中心に、数値管理・施策立案・IS組織のマネジメントを担当しています。',
        '新卒では某大手人材企業に入社し、新規プロジェクトを一任され、営業・企画・運用・改善など、事業部内のさまざまな役割を一人で担ってきました。',
        'その経験を通じて、ただ目の前の業務をこなすのではなく、数字を見ながら課題を特定し、改善し、再現性のある仕組みに変えていく力を磨いてきました。',
        '派手に語るタイプではないですが、やると決めたことをやり続けることにはこだわっています。',
        'Crestixで挑戦すること、営業組織を強くすること、そして自分自身が変わっていくことについて、リアルに話せたらと思います。'
      ]
    },
    matsuoka: {
      name: '松岡 龍士',
