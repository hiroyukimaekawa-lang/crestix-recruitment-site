 ...
 *
 * 遷移マッピング:
 *   第一営業部 (service-division1.html) : 医療マーケ
...
const DIVISION_ROUTES = {
  ...
  'インサイドセールス|チームで創る|未経験・第二新卒': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / インサイドセールス' },
  'インサイドセールス|チームで創る|3〜5年': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / インサイドセールス' },
  'インサイドセールス|チームで創る|6年以上': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / インサイドセールス' },
  'インサイドセールス|成果報酬で稼ぐ|未経験・第二新卒': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / インサイドセールス' },
  ...
  'フィールドセールス|チームで創る|未経験・第二新卒': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / フィールドセールス' },
  'フィールドセールス|チームで創る|3〜5年': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / フィールドセールス' },
  'フィールドセールス|チームで創る|6年以上': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / フィールドセールス' },
  'フィールドセールス|成果報酬で稼ぐ|未経験・第二新卒': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / フィールドセールス' },
  ...
  'カスタマーサクセス|チームで創る|未経験・第二新卒': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / カスタマーサクセス' },
  'カスタマーサクセス|チームで創る|3〜5年': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / カスタマーサクセス' },
  'カスタマーサクセス|チームで創る|6年以上': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / カスタマーサクセス' },
  'カスタマーサクセス|成果報酬で稼ぐ|未経験・第二新卒': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / カスタマーサクセス' },
  'カスタマーサクセス|成果報酬で稼ぐ|3〜5年': { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / カスタマーサクセス' },
...
const DIAG_RESULTS = {
  ...
  'インサイドセールス|チームで創る|未経験・第二新卒': { title: '【第一営業部】インサイドセールス メンバー', desc: 'チーム一丸となって医療機関へのアプローチを行う仕事です。丁寧な研修制度があり、未経験からでも安心して成長できます。', tags: ['医療マーケ', 'チーム体制', '第二新卒歓迎'], query: 'd01-is' },
  'インサイドセールス|チームで創る|3〜5年': { title: '【第一営業部】インサイドセールス アソエイト', desc: 'データとチームワークを活かし、クリニックの課題解決への足がかりを創ります。営業プロセス改善にも携われます。', tags: ['データ活用', 'チーム連携', 'キャリアアップ'], query: 'd01-is' },
  'インサイドセールス|チームで創る|6年以上': { title: '【第一営業部】インサイドセールス リーダー候補', desc: '医療機関向けIS組織のプレイングリーダーとして、アプローチ率向上の仕組み化やメンバー育成を主導します。', tags: ['プレイングリーダー', '仕組み化', '医療業界'], query: 'd01-is' },
  'インサイドセールス|成果報酬で稼ぐ|未経験・第二新卒': { title: '【第一営業部】インサイドセールス（成果連動モデル）', desc: '頑張った成果がダイレクトに評価・還元される環境で、未経験からでも高収入と営業スキルを獲得できます。', tags: ['インセンティブ', '未経験OK', '成果主義'], query: 'd01-is' },
  ...
  'フィールドセールス|チームで創る|未経験・第二新卒': { title: '【第一営業部】フィールドセールス メンバー', desc: 'チームで医療機関の課題を共有し、マイナビ送客サービスやMEOなどの提案をチーム連携で進める仕事です。', tags: ['医療マーケ', 'チーム提案', '第二新卒歓迎'], query: 'd01-fs' },
  'フィールドセールス|チームで創る|3〜5年': { title: '【第一営業部】フィールドセールス アカウントプランナー', desc: 'クリニックの状況に応じたデータドリブンな提案を、開発担当やCS担当とチームになって実行していくポジションです。', tags: ['医療マーケ', 'データ分析', 'プロジェクト営業'], query: 'd01-fs' },
  ...
  'フィールドセールス|成果報酬で稼ぐ|未経験・第二新卒': { title: '【第一営業部】フィールドセールス（ハイキャリア候補）', desc: '成果が正当に評価されるインセンティブ制度のもと、医療マーケティング分野で早期のキャリアアップを目指せます。', tags: ['ハイキャリア', '成果還元', '医療業界'], query: 'd01-fs' },
  ...
  /* ── カスタマーサクセス ────────────────────── */
  'カスタマーサクセス|裁量大きく自走|未経験・第二新卒': { title: '【第一営業部】カスタマーサクセス アシスタント', desc: 'クリニックのMEO運用や設定代行、マイナビ送客の原稿入稿管理など、医療機関の成功に自走して伴走する仕事です。', tags: ['医療マーケ', '未経験歓迎', 'サポート'], query: 'd01-cs' },
  ...
  'カスタマーサクセス|チームで創る|未経験・第二新卒': { title: '【第一営業部】カスタマーサクセス メンバー', desc: 'チームで複数クリニックを分担サポートし、運用課題を共有しながら安定したサービス継続を目指すポジション。', tags: ['医療マーケ', 'チームワーク', '安定成長'], query: 'd01-cs' },
  ...
  'カスタマーサクセス|成果報酬で稼ぐ|未経験・第二新卒': { title: '【第一営業部】カスタマーサクセス（成果連動モデル）', desc: '担当顧客のアップセル・クロスセル（追加施策提案）による利益から、高インセンティブを得られる仕事です。', tags: ['成果報酬', 'アップセル', '未経験OK'], query: 'd01-cs' },
  'カスタマーサクセス|成果報酬で稼ぐ|3〜5年': { title: '【第一営業部】カスタマーサクセス スペシャリスト', desc: '高い顧客ロイヤルティを構築し、追加提案を通じて自社サービス全体の売上に貢献するCSのスペシャリスト。', tags: ['追加提案', 'ロイヤルティ', '高歩合'], query: 'd01-cs' },
...
function showDiagResultNew() {
  ...
  const route = DIVISION_ROUTES[key] || { page: 'service-division1.html', anchor: '', divisionLabel: '第一営業部 / インサイドセールス' };
